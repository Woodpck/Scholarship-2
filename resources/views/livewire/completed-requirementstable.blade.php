            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <div class="grid grid-cols-7 gap-2">
                    ...
                    <div class="col-span-1">
                        <div class="flex">
                            <div class="relative w-full">
                                <input input wire:model.live.debounce.300ms="searchName" type="text" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 " placeholder="Name" required="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1 px-2">
                        <div class="flex">
                            <div class="relative w-full">
                                <input input wire:model.live.debounce.300ms="searchCourse" type="text" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 " placeholder="Course" required="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        <div class="flex">
                            <div class="relative w-full">
                                <input input wire:model.live.debounce.300ms="search" type="text" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 " placeholder="Scholarship Provider" required="">
                            </div>
                        </div>
                    </div>
                    <!-- Slot Opening Date -->
                    <div class="relative col-span-1 ">
                        <div class="flex">
                            <div class="relative w-full">
                                <input input wire:model.live.debounce.300ms="search" type="text" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 " placeholder="Slot Opening Date" required="">
