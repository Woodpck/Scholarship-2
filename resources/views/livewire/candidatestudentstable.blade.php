<div>
    <section>
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="overflow-x-auto flex flex-center">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 flex flex-center">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr></tr>
                        <th scope="col" class="px-4 py-3 flex items-center">STUDENT NAME</th>
            ...
            <div class="mt-8 grid grid-cols-4 gap-4 pl-7 pr-7">
                ...
                <div class="col-span-1 flex items-center justify-center">
                    <button class="bg-gray-300 text-black py-1 px-4 rounded-md shadow-md hover:bg-yellow-600 transition sm:text-md">GENERATE REPORT</button>
                </div>

                <!-- Column 2 -->
                <div class="col-span-1 flex items-center justify-center">
                    <button class="bg-gray-300 text-black py-1 px-4 rounded-md shadow-md hover:bg-yellow-600 transition sm:text-md">CREATE COMMITTEES FORM</button>
                </div>

                <!-- Column 3 -->
                <div class="col-span-1 flex items-center justify-center">
                    <button class="bg-gray-300 text-black py-1 px-4 rounded-md shadow-md hover:bg-yellow-600 transition sm:text-md">SEND TO COMMITTEE</button>
                </div>

                <!-- Column 4 -->
                <div class="col-span-1 flex items-center justify-center">
                    <button class="bg-gray-300 text-black py-1 px-4 rounded-md shadow-md hover:bg-yellow-600 transition sm:text-md">VIEW COMMITTEE</button>
                </div>
            </div>
            <div class="py-4 px-3">
